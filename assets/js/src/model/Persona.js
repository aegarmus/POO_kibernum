import regex from "../utils/consntants.js";
...
export class Persona {
  ...
  setName(newName) {
    // Expresión Regular
    this.#validateRegex(newName, regex.REGEX_NAME, "Nombre inválido");
  ...
  setLastName(newLastName) {
    this.#validateRegex(newLastName, regex.REGEX_NAME, "Apellido inválido");
  ...
  setBirthDate(newBirthDate) {
    this.#validateRegex(
      newBirthDate,
      regex.REGEX_BIRTHDATE,
      "fecha de nacimiento invalida, usa el formato YYYY-MM-DD",
    );
